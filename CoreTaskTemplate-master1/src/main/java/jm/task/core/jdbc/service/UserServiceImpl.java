...
public class UserServiceImpl extends Util implements UserService {
    ...
    public void createUsersTable() throws SQLException {
        try {
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS User (id MEDIUMINT NOT NULL AUTO_INCREMENT, name CHAR(100) NOT NULL, lastName CHAR(100) NOT NULL, age CHAR(100) NOT NULL, PRIMARY KEY (id))");
        } finally {
            if (statement != null) {
                statement.close();
            }
